...
export default function generateProjects(project, array) {
  ...
  mainLocalStorage = localStorage.getItem(
    `${project.title}`,
  ...
  function pushNewToDo(e) {
    ...
    console.log(`parsed object after pushing: ${parsedObject.arrayOfToDos}`);
    console.log(parsedObject.arrayOfToDos);
    ...
    console.log(`line 81`);
    return (mainLocalStorage = localStorage.setItem(
      `${project.title}`,
